package com.learnwithak.spring.batch.processor.json;
...
@Component
public class JsonTaskletProcessor implements ItemProcessor<Student, Student> {
    public static final Logger LOG = LoggerFactory.getLogger(JsonTaskletProcessor.class);
